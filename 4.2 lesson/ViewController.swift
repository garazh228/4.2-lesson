...
class ViewController: UIViewController {
    ...
    private var signInButton: UIButton = {
       ...
       // button.addTarget(ViewController.self, action: #selector(showNextPage), for: .touchUpInside)
...
//    }()
    ...
    override func viewDidLoad() {
        ...
        let mainImg = MainImageSettings.setupMainImage()
...
//    }
    ...
    private func setupSignUpButton() {
        vectorImage.addSubview(signUpButton)
